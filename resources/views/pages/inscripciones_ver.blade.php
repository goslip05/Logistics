            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="bg-transparent border-0 dropdown-menu">
                        ...
                        <a href="{{ route('cliente.show') }}" class="dropdown-item">Aprobar Pago</a>
            ...
            <div class="card border-left-info shadow h-100 py-2 ml-5">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1" style="margin-right: 90px; font-size: smaller">
                                Inscripciones:</div>
                                <p class="text-left ml-1 mt-3"><strong>{{$inscripciones->count()}}</strong></p>                                     
                        </div>
                        <div class="col-auto">
