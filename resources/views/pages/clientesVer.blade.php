<x-app-layout>
    ...
    <div class="content">
        ...
        <div class="px-4 pt-4 container-fluid">
            <div class="row g-4">
                <h3 class="text-primary">Clientes Inscritos</h3>
        ...
        <div class="px-4 pt-4 container-fluid">
            <div class="row g-4">
                <div class="col-sm-12 col-xl-12">
                    <div class="container">
                        <h6 class=" d-flex text-primary">DATOS CLIENTE:</h6>
                        <div class="mt-3 row">
                            <div class="col-md-6">
                                <p class="text-dark"><strong>Nombre:</strong> {{ $cliente->nombre }}</p>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-dark"><strong>documento:</strong> {{ $cliente->documento}}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-dark"><strong >Correo:</strong> {{ $cliente->email }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-dark"><strong>Telefono:</strong> ${{ $cliente->telefono }}</p>
                            </div>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="container">
                        <h6 class=" d-flex text-primary">DATOS EVENTO:</h6>
                        <div class="mt-3 row">
                            <div class="col-md-6">
                                <p class="text-dark"><strong>Evento:</strong> {{ $cliente->eventos->nombre }}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-dark"><strong>Lugar:</strong> {{ $cliente->eventos->lugar }}</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-dark"><strong>Fecha inicio:</strong> {{ $cliente->eventos->fecha_inicii}}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-dark"><strong >Fecha fin:</strong> {{  $cliente->eventos->fecha_fin }}</p>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <h6 class=" d-flex text-primary">DATOS PAGO:</h6>
                        <div class="mt-3 row">
                            <div class="col-md-6">
                                <p class="text-dark"><strong>Pago realizado:</strong> SI</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-dark"><strong>Numero pago:</strong> 382882383</p>
                            </div>
                        </div>
